            ...
            {documents?.length > 0 ? (
                documents.map((document,key) => (                 
                    <div className="frame-4">
                     <a href={`${document.s3_file_path}`}> <img className="vscode-iconsfile-type-pdf-2" src="assets/vectors/VscodeIconsfileTypePdf2_x2.svg" style={{verticalAlign:'middle',width:'20px' }} /></a>
