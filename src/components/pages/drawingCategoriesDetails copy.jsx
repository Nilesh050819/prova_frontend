...
const VisuallyHiddenInput = styled('input')`
                    ...
                    width: 1px;
                    `;
const DrawingCategoriesDetails = () => {
        ...
        const onFileChange = async (event) => {
                      ...
                      if(file.type != 'application/pdf')
                      {
                        ...
                        // setFileType(event.target.name);
                          let api = `${BASE_URL}/api/supervisor/uploadDocumentFiles?projectId=${pid}&documentId=${drawingId}&documentType=Drawing`;
                ...
                const getDocumentUploadFiles = async () => {
        ...
        <Button onChange={onFileChange}
                    ...
                    >
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                            ...
                            <div style={{ fontSize: 10, fontWeight: 500, color: '#b7b7b966' }} >Only PDF Format Supported</div>
                        </div>
            ...
            {documents?.length > 0 ? (
                documents.map((document,key) => (                 
                    <div className="frame-4">
                     <a href={`${document.s3_file_path}`}> <img className="vscode-iconsfile-type-pdf-2" src="assets/vectors/VscodeIconsfileTypePdf2_x2.svg" /></a>
                      ...
                      {key == 0 && isLoading &&  (
                       ...
                       <div><img className="vector-55" src="/images/Loader.svg" style={{marginLeft: '10px' }} /></div>
                       )}
                        {key == 0 && !isLoading &&  (
                             <a href="javascript:void(0)"><img className="vector-55" src="/images/Delete.svg" style={{marginLeft: '10px' }} onClick={() => deleteBtnClick(`${document.id}`)} /></a>
                        )}
                       {key > 0 && (
                        <a href="javascript:void(0)"><img className="vector-55" src="/images/Delete.svg" style={{marginLeft: '10px' }} onClick={() => deleteBtnClick(`${document.id}`)} /></a>
                    )}
...
export default DrawingCategoriesDetails;
