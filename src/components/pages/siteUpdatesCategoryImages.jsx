...
const getDocumentUploadFiles = async () => {
      ...
      try {
          let api = `${BASE_URL}/api/supervisor/getProjectDocumentFiles`;
            ...
            if(format(selectedRange[0].startDate, "yyyy-MM-dd") != '')
              {
...
const handleDateTypeChange = (event) => {
 ...
 <div className="space-y-4 p-4">
      ...
      {showPopup && (
   <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center overflow-visible">
   <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-[95%] sm:max-w-[400px] max-h-[80vh] overflow-visible flex flex-col">
            ...
            {documents?.length > 0 ? (
                documents.map((document,key) => (   
                  ...
                  <div className="rectangle-1">
                   ...
                   <a href="javasacript:void(0)" onClick={() => openPopup(document.s3_file_path)} >  <img className="vector-2" src="assets/vectors/Vector10_x2.svg" /></a> 
                   </div>
                     :
                     ''
                 }
